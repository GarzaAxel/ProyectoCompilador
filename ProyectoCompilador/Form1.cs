...
namespace ProyectoCompilador
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            cmbxLenguajes.DisplayMember = "Lenguaje";
            cmbxLenguajes.ValueMember = "Id_Lenguaje";            
        ...
        private void cmbxLenguajes_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (cmbxLenguajes.SelectedValue != null && int.TryParse(cmbxLenguajes.SelectedValue.ToString(), out selectedId))
            {
                if (selectedId == 1)
                {
                    ruta = @"C:\Users\eljef\Desktop\Matrices de Estado\" + selectedId.ToString() + ".csv";
                    ...
                    try
                    {
                        ...
                        rutaV = @"C:\Users\eljef\Desktop\Palabras Reservadas\PR_VB.csv";
                        string renglonV;
            ...
            else if (selectedId == 2)
            {
                ...
                try
                {
                    ...
                    rutaV = @"C:\Users\eljef\Desktop\Palabras Reservadas\PRBasic.csv";
                    string renglonV;
                    using (StreamReader lector = new StreamReader(rutaV))
                    {
                        renglonV = lector.ReadLine();
            ...
            else if (selectedId == 3)
            {
                ...
                try
                {
                    ...
                    rutaV = @"C:\Users\eljef\Desktop\Palabras Reservadas\PRC.csv";
                    string renglonV;
                    using (StreamReader lector = new StreamReader(rutaV))
                    {
                        renglonV = lector.ReadLine();
            ...
            else if (selectedId == 4)
            {
                ...
                try
                {
                    ...
                    rutaV = @"C:\Users\eljef\Desktop\Palabras Reservadas\PRClipper.csv";
                    string renglonV;
                    using (StreamReader lector = new StreamReader(rutaV))
                    {
                        renglonV = lector.ReadLine();
            ...
            else if (selectedId == 5)
            {
                ...
                try
                {
                    ...
                    rutaV = @"C:\Users\eljef\Desktop\Palabras Reservadas\PRCobol.csv";
                    string renglonV;
                    using (StreamReader lector = new StreamReader(rutaV))
                    {
                        renglonV = lector.ReadLine();
            ...
            else if (selectedId == 6)
            {
                ...
                try
                {
                    ...
                    rutaV = @"C:\Users\eljef\Desktop\Palabras Reservadas\PR_Dbase.csv";
                    string renglonV;
                    using (StreamReader lector = new StreamReader(rutaV))
                    {
                        renglonV = lector.ReadLine();
            ...
            else if (selectedId == 7)
            {
                ...
                try
                {
                    ...
                    rutaV = @"C:\Users\eljef\Desktop\Palabras Reservadas\PRFortran.csv";
                    string renglonV;
                    using (StreamReader lector = new StreamReader(rutaV))
                    {
                        renglonV = lector.ReadLine();
            ...
            else if (selectedId == 8)
            {
                ...
                try
                {
                    ...
                    rutaV = @"C:\Users\eljef\Desktop\Palabras Reservadas\PR_Java.csv";
                    string renglonV;
                    using (StreamReader lector = new StreamReader(rutaV))
                    {
                        renglonV = lector.ReadLine();
            ...
            else if (selectedId == 9)
            {
                ...
                try
                {
                    ...
                    rutaV = @"C:\Users\eljef\Desktop\Palabras Reservadas\PRPascal.csv";
                    string renglonV;
                    using (StreamReader lector = new StreamReader(rutaV))
                    {
                        renglonV = lector.ReadLine();
            ...
            else if (selectedId == 10)
            {
                ...
                try
                {
                    ...
                    rutaV = @"C:\Users\eljef\Desktop\Palabras Reservadas\PRPython.csv";
                    string renglonV;
                    using (StreamReader lector = new StreamReader(rutaV))
                    {
                        renglonV = lector.ReadLine();
            ...
            else if (selectedId == 11)
            {
                ...
                try
                {
                    ...
                    rutaV = @"C:\Users\eljef\Desktop\Palabras Reservadas\PRVisualFoxpro.csv";
                    string renglonV;
                    using (StreamReader lector = new StreamReader(rutaV))
                    {
                        renglonV = lector.ReadLine();
        ...
        {
            string query = "Select Lenguaje from Lenguaje where Id_Lenguaje = @Id_Lenguaje";
            ...
            string rutaCompletaArchivo = Path.Combine(@"C:\Users\eljef\Desktop\Salida\\", nombreArchivo);
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            CMD.Parameters.AddWithValue("@Id_Usuario", idusuarioreal);
            CMD.Parameters.AddWithValue("@Id_Lenguaje", selectedId);
