...
namespace ProyectoCompilador
{
    ...
    {
        SqlConnection conexion = new SqlConnection("Data Source = LAPTOP-B2J62JB7; Initial Catalog = CompiladorDB; Integrated Security = True ");
        public Reporte()
        {
            InitializeComponent();
        }
        ...
        {
            string consulta = "select us.Usuario 'Usuario', le.Lenguaje 'Lenguaje', re.Fecha_Hora 'Fecha y Hora', re.Archivo 'Archivo Salida' from Registro re INNER JOIN Usuarios us on re.Id_Usuario = us.Id_Usuario INNER JOIN Lenguaje le on re.Id_Lenguaje = le.Id_Lenguaje";
        ...
        {
            string filePath = "C:\\Users\\eljef\\Desktop\\archivo.xlsx";
